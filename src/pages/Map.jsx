...
const Map = () => {
  ...
  return (
    <div>
  <div style={{width:"80%",height:"420px",backgroundColor:"#f6e1e9",margin:"auto",padding:'20px 0px 0px 0px'}}>
    <div style={{width:"30%",height:"45px",backgroundColor:"white",margin:"auto",border:"2px solid",borderRadius:"5px",display:"flex",justifyContent:'center'}}>
        <div >Login/Sign Up</div>
        <img style={{height:"30px",width:"30px",marginTop:"5px" }} src='https://in.sugarcosmetics.com/guestCheckout/forwardbutton.svg' alt='no'/></div>
    <p style={{backgroundColor:"#f6e1e9"}}>OR</p>
    <p style={{backgroundColor:"#f6e1e9"}}>Register</p>
    <div style={{display:"flex",flexDirection:"column",gap:"15px",width:'75%',margin:"auto",backgroundColor:"#f6e1e9" }}>
        <div className={styles.a1}>
            <input placeholder='Full Name' name='name' ref={name}/>
            <input placeholder='Company(Optional)' name='company' ref={company}/>
        ...
        <div className={styles.a2}>
            <input placeholder='Apartment Address'name='apartment' ref={apartment}/>
    ...
    <button onClick={()=>navigate("/cart")} style={{backgroundColor:"#212529",color:'white'}}>Cancel</button>
    <button style={{backgroundColor:"#fc2779", color:'white'}} onClick={handle}>Save and use this address</button>
    </div>
