...
if(flag200===true)
  ...
  return (
    ...
    <div className={styles.q4}>
        <div>
        <div style={{display:"flex"}}><img onClick={()=>navigate("/")} style={{marginTop:"3px"}} src='https://in.sugarcosmetics.com/desc-images/breadcrumb_home.svg' id={styles.e1} alt="no"/><p> / Trending</p></div>
          <br></br>
          <div>TRENDING - 16 items</div>
        </div>
